                                     ...
                                     { 
                                        if (i==0)
                                         { 
                                            ...
                                            $('#x').fadeTo("fast", 0.0);//sol se esconde
                                            $('#eren').fadeTo("fast", 1.0);//sale la luna
                                            i++;
                                         ...
                                         { 
                                            ...
                                            $('#caracol1').animate({ marginBottom:nueva_profun});
                                            $('#eren').fadeTo("fast", 0.0);//luna se esconde
                                            $('#x').fadeTo("fast", 1.0);//sale el sol
                                             i = 0; 
                                      ...
                                      if(parseInt(termina)>=profundidad)
                                         {
                                           alert("El caracol ha salido"+"en el dia"+dia);
                                         }
                                      }  
                                   } 
                               }
