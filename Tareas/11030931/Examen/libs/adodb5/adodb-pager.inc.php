...
class ADODB_Pager {
	...
	var $first =   '<button type= "button" class="btn" id="btn1"> 
                  Primera
                  </button>';   //'<code>xxx</code>'; 
	var $prev =  '<button type= "button" class="btn"  id="btn2"> 
                  Anterior
                  </button>';//'<code>&lt;&lt;</code>';
	var $next =   '<button type= "button"  class="btn" id="btn3"> 
                  Siguiente
                  </button>';//'<code>Siguiente</code>';
	var $last =  '<button type= "button" class="btn"  id="btn4"> 
                  Ultimo
                  </button>';//'<code>>Retrocede</code>';
	var $moreLinks = '...';
	var $startLinks = '...';
	...
	global $PHP_SELF;
		if ($anchor) {
	?>
		<a class="btn" href="<?php echo $PHP_SELF,'?',$this->id;?>_next_page=1"><?php echo $this->first;?></a> &nbsp; 
	<?php
		} else {
			print "$this->first &nbsp; ";
		}
