          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                     ...
                     <li class="active"><a href="<?php echo BASEURL; ?>/views/11030931/datos_personales.php">Datos-Personales</a></li>
                <li class="divider"></li>
                
                     <li class="active"><a href="<?php echo BASEURL; ?>/views/11030931/medico.php">Datos-Medicos</a></li>
                <li class="divider"></li>
                     <li class="active"><a href="<?php echo BASEURL; ?>/views/11030931/usuario.php">Usuarios</a></li>
              </ul>
            </li>
